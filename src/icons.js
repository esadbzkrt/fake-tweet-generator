...
const defaultColor = "#6e767d";
const defaultWidth = 24
const defaultHeight = 24

const ReplyIcon = ({color,width,height}) => {
    return (
        <svg fill={color||defaultColor} width={width||defaultWidth} height={height||defaultHeight} viewBox="0 0 24 24" aria-hidden="true"
             >
            <g>
                <path
...
const LikeIcon = ({color,width,height}) => {
    return (
        <svg fill={color||defaultColor} width={width||19} height={height||defaultHeight} viewBox="0 0 24 24" aria-hidden="true"
             >
            <g>
                <path
...
const VerifiedIcon = ({color,width,height}) => {
    return(
        <svg fill={color||"white"} width={width||defaultWidth} height={height||19} viewBox="0 0 24 24" aria-label="Onaylanmış hesap" role="img">
            <g>
                <path
